...
# Symlinks anlegen
mkdir -p "$SKILLS_DIR"
for skill in envato google-analytics google-search-console handoff humanizer-de image-optimize kanboard kimai mail-as-me mainwp md2pdf php-formatting pushover ripgrep swaks swos tcsh telegram wetter wiki wp-cli wp-nf wp-pys wp-sync-dev; do
