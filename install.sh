...
# Symlinks anlegen
mkdir -p "$SKILLS_DIR"
for skill in envato google-analytics handoff humanizer-de image-optimize kanboard kimai mainwp md2pdf php-formatting ripgrep swaks tcsh wetter wiki wp-cli wp-pys wp-sync-dev; do
